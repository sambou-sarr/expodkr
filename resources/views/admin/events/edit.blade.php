                    ...
                    <div class="p-5 flex flex-col gap-3">
                        ...
                        <div x-data="{ confirmDelete: false }">
                            <button type="button"
                                    ...
                                    class="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-semibold text-red-500 border border-red-100 hover:bg-red-50 hover:border-red-200 transition-all">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <div x-show="confirmDelete" x-cloak
                                ...
                                <p class="text-xs font-semibold text-red-700 mb-3">
                                    ...
                                    <span class="font-normal text-red-500">Cette action est irréversible.</span>
                                </p>
                                <div class="flex gap-2">
                                    <button type="button" @click="confirmDelete = false"
                                            class="flex-1 py-2 rounded-lg text-xs font-semibold text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 transition-colors">
                                        Annuler
                                    </button>
